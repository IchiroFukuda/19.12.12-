...
class HowToViewController: UIViewController {
    ...
    func setUpLayout(){
        ...
        sentence1.text = "あなたは何故、禁欲をするのでしょうか。途中で、目的を見失わないためにも、何故禁欲をするのかを明確にしておく事は非常に重要です。禁欲には様々なメリットがありますが、一番は、男らしいハングリー精神が身に付くことだと思います。「女が欲しい、金が欲しい、もっと、もっとかっこいい男になりたい。」といった気概が不思議と出てきます。自慰をしていると、自慰に意思力を削がれ、馬力が出ず、やるべき時に力が出ない、かつそんなショボい自分でも簡単に気持ち良くなるから、自分を向上させようと言った気力も出ない。そしてどんどんダサく弱くなっていく悪循環にはまります。男らしく生きたい。その思いがあるならば、それだけで十分禁欲をする理由があると思います。"
        sentence1.sizeToFit()
        ...
        sentence2.text = "禁欲には、苦しみが伴います。まず、薬物中毒のように、脳が定期的な快楽物質の供給に慣れているので、禁欲をすると禁断症状が現れます。この禁断症状が生じたとき、（かなり難しいことだとは思いますが、）自分の真に望んでいることを、紙に書いて脳に刻み込む事が、禁欲継続のコツとなります。「今すれば、確かに気持ちが良い。しかし、それは自分が真に心から望んでいることなのか？」と紙に書いて己に問うのです。"
        sentence2.sizeToFit()
        ...
        sentence3.text = "個人差がありますが、禁欲には以下の効果があると言われています。\n・髪サラ効果\n・肌質改善\n・ハゲ予防\n・コミュ力の向上\n・顔が凛々しくなる\n・筋肉が付きやすくなる\n・男に舐められなくなる\n・行動力が増す\n・集中力が増す。\nこれらの効果を感じる事で、禁欲が楽しくなります。むしろ自慰をするのが怖くなる事でしょう。"
        sentence3.sizeToFit()
        ...
        sentence4.text = "禁欲を長く続けていると、覚醒するステージを経験します。体から何やらオーラのような、熱気が発せられ、顔つきが別人のようにキリッとし、集中力が高まります。あらゆる物事に意欲的に取り組むようになり、勉学やスポーツで結果を残すことができるようになります。その姿は、女から見て魅力的である事は間違いなく、モテるようになります。"
        sentence4.sizeToFit()
        ...
        sentence5.text = "禁欲とは、すなわち、有利な状況下で敵と戦うための、兵力の温存です。今の時代は、インターネットの発達により、ほとんどの男達が毎晩自慰をして気力を消耗しています。ここでもしあなたが禁欲をすれば、周囲のほとんどの男たちよりも多くの精神力と体力を残す事ができ、あらゆる競争で有利な立ち位置をキープする事ができます。そして大事な事は、この状況を生かして勝つ事です。ただ兵力を温存するだけでは、宝の持ち腐れと言っても過言ではありません。温存した兵力を使って、何か目的を達成して初めて、禁欲は意味を持ちます。"
        sentence5.sizeToFit()
        ...
        sentence6.text = "禁欲が完全に生活に組み込まれ、習慣化すると、「自慰？何それ美味しいの？」とサラッと言える状態になります。「それより、ちょっと今自分の人生を向上させることで忙しいから、下らないことに時間使ってる暇無いわ。」と自分の中に芯が生まれ、自分軸で生きていけるようになります。あなたはついに欲望を置き去りにするのです。ここまで来れば、自分を禁欲マスターと称してもいいでしょう。"
        sentence6.sizeToFit()
