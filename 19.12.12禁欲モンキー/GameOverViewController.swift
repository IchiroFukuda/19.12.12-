...
class GameOverViewController: UIViewController {
    private lazy var gameOverLabel: UILabel = {
       ...
       var commentArray = ["休みすぎて後ろからチーターに襲われた。まずは禁欲を１日やってみるが良い。","一人で孤独に死んでいった。","無様に死んだ。","男にはやれねばならない時がある。","4","自分を鍛えていなかったために、敵に殴られ死んだ。","","オナ禁によって人間力を磨いていなかったために、群れの者達がボイコットを起こし、群れの再建が頓挫した。","オナ禁パワーが足りなかった。無様に死んでいった。","",""]
